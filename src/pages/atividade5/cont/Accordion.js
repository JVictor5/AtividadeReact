...
export default function Accordion(){
    ...
    return(
        ...
        onShow={() => setActiveIndex(0)}>
            with a population of about 2 million, Almaty is Kazakhstan's largest cit. From 1929 to 1997, it was its capital city.
        </Panel>
        <Panel
        title="Etymology"
        isActive={activeIndex === 1}
        onShow={() => setActiveIndex(1)}>
            The name comes from <span lang="kk-KZ">sei</span>
            the Kazkh word for "apples" and is often translated
